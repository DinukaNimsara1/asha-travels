  ...
  return (
    <section className="bg-slate-50 py-8 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative flex overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] group">
          <div className="flex gap-16 pr-16 items-center animate-[marquee_30s_linear_infinite] group-hover:[animation-play-state:paused] whitespace-nowrap min-w-full w-max">
